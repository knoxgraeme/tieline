...
- **Approach:**
  ...
  4. Provide at most four isolated parser workers, never share mutable parser/cursor state across requests, and explicitly clean up `Tree`, `Query`, and parser objects.
